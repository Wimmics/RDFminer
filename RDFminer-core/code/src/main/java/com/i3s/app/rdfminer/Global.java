...
public class Global {
    ...
    public static final int SERVER_PORT = Integer.parseInt(System.getenv("RDFMINER_CORE_PORT"));

    public static final String VERSION = System.getenv("RDFMINER_VERSION");
     ...
     */
    public static final String CACHES = HOME + "/io/caches/";
...
//    public static final String DBPEDIA_TDB_PATH = HOME + "/tdb/";
     ...
     */
    public static String SPARQL_ENDPOINT = "http://corese:" + System.getenv("CORESE_PORT") + "/sparql"; // "http://172.19.0.1:" + System.getenv("CORESE_PORT") + "/sparql";
